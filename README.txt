...
- 小字统一到 14px。方案名 22px，应用标题 16px，应用说明和「推奨 SoC」14px；原先 11px 及以下的字也升到 14px。
- ESP-Mosaico 产品图改为本地 assets/esp-mosaico.png（透明背景）。框高 156px，照片贴齐框的上下边并靠左，角标 “Built for Coding Agents.” 留在右下角。
- 方案区软件栈概念图左移 30px。
- 页脚二维码卡片加宽到 190px。
